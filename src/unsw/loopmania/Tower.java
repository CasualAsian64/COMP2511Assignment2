...
public class Tower extends Building implements EnemyTriggerBuilding {
    ...
    */
    ...
    /**
    * Inflict damage on to the enemy within the tower's radius
    * Return true if the enemy is killed, false if not. 
    * @param statistics
    */
    public boolean towerInflictDamage(Statistics statistics) {
        ...
        // else deal 5 damage 
            ...
            System.out.println("An enemy within the radius took damage from the tower and now has health " + statistics.getHealth());
